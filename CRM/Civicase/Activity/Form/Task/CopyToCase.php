 ...
 */
class CRM_Civicase_Activity_Form_Task_CopyToCase extends CRM_Activity_Form_Task {
  ...
  public function postProcess() {
    ...
    foreach ($this->_activityHolderIds as $key => $id) {
      ...
      if (CRM_Case_BAO_Case::checkPermission($id, 'File On Case', $defaults['activity_type_id'])) {
        ...
        CRM_Core_Session::setStatus(ts('Not permitted to copy activity %1 %2.', array(
    ...
    CRM_Core_Session::setStatus($filedActivities, ts("Activities Copied"), "success");
