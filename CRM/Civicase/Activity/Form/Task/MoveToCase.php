 ...
 */
class CRM_Civicase_Activity_Form_Task_MoveToCase extends CRM_Activity_Form_Task {
  ...
  public function postProcess() {
    ...
    foreach ($this->_activityHolderIds as $key => $id) {
      ...
      if (CRM_Case_BAO_Case::checkPermission($id, 'Move To Case', $defaults['activity_type_id'])) {
        ...
        CRM_Core_Session::setStatus(ts('Not permitted to move activity %1 %2.', array(
    ...
    CRM_Core_Session::setStatus($filedActivities, ts("Activities Moved"), "success");
